<template>
  <div style="padding-top:112px;">
      <article>
        <div class="title">
          <h1><small>恒佳株式会社について</small>執行役員メッセージ</h1>
        </div>
        <!--title-->
        <div class="contents">
          <div class="contents-style">
            <div class="message">
              ...
              <div class="message__text">
                <p>恒佳株式会社は2012年7月24日（平成24年）に設立し、この十年間にわたり、「美」「健康」「ゆとり」「時代の空気」などの側面からお客さまの暮らしの質的向上を応援するという理念を貫いており、日本の健康食品、漢方薬、化粧品を世界の方々にお求めやすい価格でお届けすることを約束します。<br />
                <br>
                ...
                <p class="text-align--right">2022年4月1日</p>
              </div>
              <!--message__text-->
    ...
    <div class="topic-path">
      <ol>
        ...
        <li><NuxtLink to="/about">執行役員メッセージ</NuxtLink></li>
      </ol>
    </div>
    <!--topic-path-->
  </div>
